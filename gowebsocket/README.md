...
```markdown
    go get github.com/kylin-public/kylin-autosolve-client-go/gowebsocket
```
...
- Please checkout [**examples/gowebsocket**](!github.com/kylin-public/kylin-autosolve-client-go/tree/master/gowebsocket/examples/gowebsocket) directory for detailed code..
